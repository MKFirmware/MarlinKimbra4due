...
#define Z_PROBE_OFFSET {0, 0, -1}                  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe. X & Y must are integer...
...
#define DEFAULT_MAX_FEEDRATE          {500,500,500,50,50,50,50}             // X, Y, Z, E0...(per extruder). (mm/sec)
